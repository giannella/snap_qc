...
1_data_munging_and_income_var_recovery.R is about feature engineering from the public data available at snapqcdata.net, including reconstructing the values just mentioned. /n
2_state_reg_trees.R generates a png and pdf regression tree for each state. You can easily modify to just do one state. Modify the features list as appropriate./n
