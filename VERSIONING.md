...
Three things are "interface" here, and changing any of them incompatibly is a
breaking change:
...
workflow; by the same principle, exploration never drives a release. Auditions,
sweeps, and retired claims accumulate quietly on `main` and in
