...
#
# Parallel to EXCL_optimize_single_exclusion_rule_by_hh_size_for_a_state.R, but for FLAGGING (inclusion).
...
# Paste an INCLUDE rule from INCL_find_inclusion_rules_multi_model_by_hh_size.R.
