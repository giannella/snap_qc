...
| Fresh-share floor (f >= 0.50, two-pass walk on core and buffer): the first selection intervention to clear the §30 bar (+0.0118 vs +0.010 at the 5% budget, dollar recall held, workload identical by construction) | candidate, NOT shipped: second-era replication (FY2017-18 to FY2019, 18 states) is mandatory before promotion, then Eric's MINOR-bump call. The 0.60 grid peak is a pre-registered question for that replication, not a chosen threshold | one era confirmatory (FY2022-23 to FY2024, 49 states), pre-registered, one shot | §33 |
