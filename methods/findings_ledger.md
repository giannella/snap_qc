...
| Characterization-profile distance as an estimable proxy for rule complementarity (profiles have support where marginal slices do not) | open; pairwise diagnostic planned before any arm; feeds the preference-ordering study | none | §32 follow-up note; §29, §31 |
