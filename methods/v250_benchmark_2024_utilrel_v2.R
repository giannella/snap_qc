...
# PROMOTED 2026-08-22: utilities_sua is now a frame column (features.R
# add_sua_tier, the single definition); the study-local construction that
# produced the era-1 result was verified row-identical to it
# (frame_tier_equivalence.R). The driver reads the column.
