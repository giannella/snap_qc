# ERA-2 REPLICATION, BASELINE ARM (raw utilities; methods/v250_benchmark_2024_utilrel/era2_design_note.md).
# Derived from the variant driver with the vocabulary reverted; header below is inherited.
...
OUT_DIR <- "methods/v250_benchmark_2024_utilrel/era2_baseline"
...
if (requireNamespace("jsonlite", quietly = TRUE))
  jsonlite::write_json(
    list(built = "era-2 replication, BASELINE raw utilities: fresh mines train FY2017-18, walk FY2019, seed 117, current frame",
