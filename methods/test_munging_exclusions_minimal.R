...
#
#   Rscript methods/test_munging_exclusions_minimal.R
#
# Writes:
#   methods/munging_exclusion_check/reg_model_data_minexcl.rds  (~60 MB, not committed)
#   methods/munging_exclusion_check/final_minexcl.rds           (intermediate)
#
...
#   Measured by methods/measure_benmax_filter.R, it drops 9,456 rows, all of them FY2021
...
OUT_DIR <- file.path(FOLDER, "methods/munging_exclusion_check")
